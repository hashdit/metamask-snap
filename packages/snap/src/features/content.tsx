...
export const errorContent = (
	<Box>
		<Heading>HashDit Snap</Heading>
		<Text>
			If this is your first time installing HashDit Snap, this message is
			expected. An error occurred while retrieving the risk details for
			this transaction. If the issue persists, please try reinstalling
...
export const notSupportedChainContent = (
	<Box>
		...
		<Text>
			Sorry! This blockchain network is not currently supported by HashDit
			Security Insights. Full security analysis is available for{' '}
			<Bold>Ethereum</Bold> and <Bold>Binance Smart Chain</Bold> networks.
		</Text>
	</Box>
);
